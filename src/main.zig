...
pub fn main() !void {
    ...
    // Day 12
    var d12 = InnerArray{};
    defer d12.deinit(allocator);

    try d12.append(allocator, .{ .f = day12.part1, .file_path = "input/input_day12" });
    // try d12.append(allocator, .{ .f = day12.part2, .file_path = "input/input_day12" });

    try days.append(allocator, d12);
